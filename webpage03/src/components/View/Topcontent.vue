	...
	<div class="top">
			<div class="container">
				<div class="row">
					...
					<img class="visible-xs-block visible-sm-block" src="http://glx.cdutetc.cn/img/top.gif"/></a></div>
					<div class="col-md-5">
						<ul class=''>
				    	...
				    	<div class="search pull-right visible-md-block visible-lg-block">
				    		<form class="form-horizontal" role="form" method="get" action="http://www.baidu.com/baidu">	
								  <div class="form-group">
								    ...
								    <div class="col-md-6">
								      	<input type="word" name="word" class="form-control input-sm" id="word" placeholder="请输入搜索关键字">		    		
								        <input name="tn" type="hidden" value="bds">
								        <input name="cl" type="hidden" value="3">
								        <input name="si" type="hidden" value="dxx.cdutetc.cn">
								        <input name="ct" type="hidden" value="2097152">
								    </div>
								    <div class="col-md-3 none-padding"><input type="submit" class="btn btn-default btn-sm" value="站内搜索"></input></div>
								  </div>
							 </form>
				    	</div>
					</div>
...
.top{background:#003366; width: 100%;}
