	...
	<div class="top">
			<div class="container">
				<div class="row">
					...
					<img class="hidden-xs hidden-sm sc" src="../../assets/images/top.png"/>
					<img id="aaa" class="visible-xs-block visible-sm-block" src="http://glx.cdutetc.cn/img/top.gif"/></a></div>
					<div class="col-md-5">
						<ul class='a'>
